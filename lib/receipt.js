...
export async function buildReceipt(data) {
  ...
  // Logo (using printer center just for image or left)
  // To avoid image pushing right, we keep align left, 192 is half of 384, so it might be off-center.
  // We will try standard align left for the whole document to avoid right-shifting.
  try {
